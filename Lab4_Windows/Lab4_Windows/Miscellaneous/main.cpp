...
bool animate = false;
bool animate2 = false;
float headRotPos = 0.0;
float headRotDelta = 30;
...
void drawSpirit() {
	...
	glRotatef(headRotPos, 0, 0, 1);//animation
	glRotatef(180, 0, 0, 1);
...
void Timer(int value) {
	...
	headRotPos += headRotDelta;
	if (headRotPos >= 90 || headRotPos <= 30)//alternative values are 60,-60
		headRotDelta = -headRotDelta;
